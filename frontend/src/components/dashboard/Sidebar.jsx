        ...
        {!collapsed && (
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center">
              <img className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" src='public/Logo.png'/>
            </div>
            <span className="font-bold text-gray-900">Proyect Thot</span>
          </div>
        )}
        <button
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 truncate capitalize">{usuario?.rol}</p>
              </div>
            </div>
            <button
